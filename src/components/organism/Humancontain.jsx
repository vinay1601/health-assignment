    ...
    return (
        <div className='grid grid-cols-2'>
            <div className='w-full h-full flex justify-center col-span-2 md:col-span-1 items-center p-4 mt-3.5'>
                <div className='relative w-[170px] md:w-[150px] 5xl:w-[210px]'>
                    <Image src={bodyImage}
                        alt="Human Anatomy"
                    ...
                    <div className='absolute top-[18%] right-[-46%] 5xl:right-[-32%] bg-blue-600 text-white px-3 py-1 rounded-full shadow-md text-sm md:text-[11px] flex items-center gap-1'>
                        <FaHeart className='text-red-600 text-[12px]' /> Healthy Heart
                    </div>

                    <div className='absolute bottom-[24%] left-[-40%] 5xl:left-[-20%] md:left-[-29%] bg-teal-500 text-white px-3 py-1 rounded-full shadow-md text-sm md:text-[11px] flex items-center gap-1'>
